...
public class CoreSetup implements Serializable{
     ...
     * 授权方式
     */
    public String Devcode = "QMVPAMLUZYBFCGF";//项目授权，开发码设置
     ...
     * 保存图片
     */
    public String savePicturePath = Environment.getExternalStorageDirectory().getPath() + "/portableBalance/carPlate/" + "/DCIM/Camera/Plateid.jpg";//设置为""则不保存。
