...
public class MyImageView  extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        /*        LogUtil.debugLog("RoundImageView", "onDraw" + drawable);*/
        Bitmap b = ((BitmapDrawable) drawable).getBitmap();
        /*        LogUtil.debugLog("RoundImageView", "onDraw" + b);*/
        if (b == null) {
            // return;
            b = ((BitmapDrawable) getContext().getResources().getDrawable(R.mipmap.user_icon)).getBitmap();
            if (b == null) {
                return;
            }
        }
    ...
    public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius) {
        ...
        canvas.drawCircle(scaledSrcBmp.getWidth() / 2.0f, scaledSrcBmp.getHeight() / 2.0f,
                scaledSrcBmp.getWidth() / 2.0f, paint);
    ...
    private void drawCircleBorder(Canvas canvas, int radius, int color) {
        ...
        canvas.drawCircle(defaultWidth / 2.0f, defaultHeight / 2.0f, radius, paint);
    }
