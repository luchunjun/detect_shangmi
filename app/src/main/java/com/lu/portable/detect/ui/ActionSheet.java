...
public class ActionSheet extends Dialog implements OnClickListener {
    ...
    private View createView() {
        ...
        FrameLayout.LayoutParams mPanelParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT,
    ...
    public ActionSheet addItems(ArrayList titles) {
